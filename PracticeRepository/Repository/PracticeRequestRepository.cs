...
public class PracticeRequestRepository:IPracticeRequestRepository
{
    ...
    private readonly ILogger<PracticeRequestRepository> _logger;

    public PracticeRequestRepository(PracticeRepositoryContext dbContext, ILogger<PracticeRequestRepository> logger)
    {
        _logger = logger;
